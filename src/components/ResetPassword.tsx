      ...
      firebase
        ...
        .then(() => {
          setMessage({
            ...
            display: true,
            message:
              'Password successfully modified. You will be redirect soon for loggin',
          })
          setTimeout(() => {
            history.push('/login')
          }, 4000)
    ...
    <section className="h-screen flex flex-col justify-center items-center">
      <div className="max-w-3xl px-6 py-16 mx-auto text-center">
          ...
          message.status ? (
            <div className="w-full text-white bg-green-500 my-5">
              <div className="container flex items-center justify-between px-6 py-4 mx-auto">
                ...
                <button
                  onClick={() => setMessage({ display: false })}
        ...
        <p className="max-w-md mx-auto mt-5 text-gray-500 dark:text-gray-400">
          Saisissez votre nouveau mot de passe à deux reprises. Notez le dans un
          coin de votre tête, il vous sera utile lors de votre prochaine
          connexion.
        </p>
