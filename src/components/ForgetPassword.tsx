  ...
  return (
    <section className="h-screen flex flex-col justify-center items-center">
      <div className="max-w-3xl px-6 py-16 mx-auto text-center">
        <Link
          to="/login"
          className="text-left mb-5 flex items-center text-gray-400">
          <ArrowLeftIcon className="w-5 h-5 mr-1" /> Back to login
        </Link>
        {message.display ? (
          message.status ? (
        ...
        <p className="max-w-md mx-auto mt-5 text-gray-500 dark:text-gray-400">
          Pas de panique, un email de récupération vous sera envoyé une fois le
          formulaire rempli.
        </p>
